...
int main ( int argc, const char** argv ) {
  ...
  std::string settings  = "/Users/nick/physics/analysis/jet_playground/build/settings/reader.txt";
  std::string data      = "/Users/nick/physics/analysis/jet_playground/test_data/picoDst_25_35_0.root";
...
std::string create_file_name( const std::string& algorithm, double resolution, bool inclusive,
  ...
  std::string base_dir = "/Users/nick/physics/analysis/jet_playground/build/training/";
