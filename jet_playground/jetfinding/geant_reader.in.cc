...
geant_reader::geant_reader() {
  settings_ = "${CMAKE_BINARY_DIR}/settings/reader.txt";
  input_file_path_ = "";
...
geant_reader::geant_reader( const std::string& settings_doc, const std::string& input_file ) {
  if ( settings_doc == "" ) settings_ = "${CMAKE_BINARY_DIR}/settings/reader.txt";
...
bool geant_reader::init() {
  ...
  // hot towers
  geant_reader_.GetTowerCuts()->AddBadTowers( "${CMAKE_SOURCE_DIR}/jet_playground/jetfinding/dummy_tower_list.txt" );
  pythia_reader_.GetTowerCuts()->AddBadTowers( "${CMAKE_SOURCE_DIR}/jet_playground/jetfinding/dummy_tower_list.txt" );
